...
# =====================================================================
# سيقرأ الرابط تلقائياً من إعدادات Render أو يستخدم الرابط المحلي إذا وُجد
DATABASE_URL = os.getenv("DATABASE_URL", "postgresql://postgres:postgres@localhost:5432/balsam_db")

# تصحيح روابط Render القديمة إن بدأت بـ postgres:// بدلاً من postgresql://
...
# =====================================================================
# قوالب HTML (تم الإبقاء على نفس تصميمك الأصلي بالكامل)
# =====================================================================
HTML_PATIENT = """
<!DOCTYPE html>
...
if __name__ == '__main__':
    try:
        ...
        print(f"تحذير: تعذر تجهيز قاعدة البيانات عند بدء التشغيل: {e}")

    # قراءة المنفذ من الخادم السحابي
